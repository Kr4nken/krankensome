...
local WIDGET_DIR = HOME_DIR .. '/.config/awesome/modules/todo_widget'
local STORAGE = HOME_DIR .. '/.cache/awesome/todo-widget/todos.json'
local WIDGET_THEME_DIR = HOME_DIR .. '/.config/awesome/themes/relz/icons/widgets/todo'
...
local add_button = wibox.widget {
    {
        {
            image = WIDGET_DIR .. '/list-add-symbolic.verticalsvg',
            resize = false,
            widget = wibox.widget.imagebox
        },
        top = 11,

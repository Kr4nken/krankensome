...
BatteryWidget_prototype = function()
  ...
  this.__private = {
    ...
    local text =   "Charge:         " .. this.__private.capacity .. "%\n"
    text = text .. charging_or_discharging .. this.__private.remaining_time .. "\n" 
    text = text .. "Wear level:    " .. this.__private.wear_level .. "%"
    return text
    end,
    update = function()
